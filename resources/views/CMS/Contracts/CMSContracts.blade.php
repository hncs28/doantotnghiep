<head>
    ...
    <body>
        ...
        <div class="container">
                ...
                <tbody>
                    @foreach($contracts as $contract)
                        <tr>
                            ...
                            <td>
                                <a href="/CMS/Contracts/edit/{{$contract->contractID}}">
                                    <button type="button" class="btn btn-edit">Edit</button>
                                </a>
                                <form method="POST" action="/CMS/Contracts/destroy/{{$contract->contractID}}"
            ...
            <a href="/CMS/Contracts/create" class="btn-add">Add New Contract</a>
        </div>
    </body>
