                ...
                <thead class="bg-gray-200">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                            Request ID</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">User
                            Name</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                            Detail Name</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                        ...
                        <tr>
                            ...
                            @if ($request->requestState == 'Đã xử lý')
                                <td class="px-6 py-4 whitespace-nowrap"><button
                                        class="bg-blue-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded">Approved</button>
                                </td>
                            @else
                                <form action="/CMS/FormaRequests/update/{{ $request->requestID }}" method="POST">
                                    @csrf
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <button
                                            class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">Approve</button>
                                    </td>
                                </form>
                            @endif
                        </tr>
